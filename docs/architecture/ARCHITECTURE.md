...
<!-- toc:begin — generated by architecture-docs-scaffold.sh; do not hand-edit -->
...
- [`consumer-app-migration-guide`](cross-cutting/consumer-app-migration-guide.md)
- [`customization-surface`](cross-cutting/customization-surface.md)
- [`demo-showcase`](cross-cutting/demo-showcase.md)
- [`flavors-extension`](cross-cutting/flavors-extension.md)
- [`source-set-hierarchy`](cross-cutting/source-set-hierarchy.md)
- [`store-architecture`](cross-cutting/store-architecture.md)
- [`store-data-api`](cross-cutting/store-data-api.md)
- [`style-guide`](cross-cutting/style-guide.md)

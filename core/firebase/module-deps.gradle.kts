...
// module-deps.gradle.kts — the FORK-OWNED dependency seam for `core/firebase` (white-label).
//
// `core/firebase/build.gradle.kts` is template-owned and FULL-COPIES on `/kmp-project-template-sync`.

...
// module-deps.gradle.kts — the FORK-OWNED dependency seam for `core/domain` (white-label).
//
// `core/domain/build.gradle.kts` is template-owned and FULL-COPIES on `/kmp-project-template-sync`.

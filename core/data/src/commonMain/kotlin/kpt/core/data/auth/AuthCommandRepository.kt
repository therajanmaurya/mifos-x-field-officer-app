...
/**
 * Every auth write, as an explicit outcome.
 *
...
interface AuthCommandRepository {
    ...
    suspend fun authenticate(postAuthenticationRequest: PostAuthenticationRequest): MutationResult<PostAuthenticationResponse>
}

...
internal class SurveyRepositoryImpl(
    @FromStore(AppStoreIds.Surveys) private val store: Store<Unit, List<SurveyEntity>>,
) : SurveyRepository {
    ...
    override fun surveysStream(scope: CoroutineScope): ScreenDataStream<List<SurveyEntity>> =

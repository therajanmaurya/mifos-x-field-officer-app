...
/**
 * Every survey write, as an explicit outcome.
 *
 ...
 */
interface SurveyCommandRepository {

    suspend fun submitScore(surveyId: Int, scorecardPayload: Scorecard?): MutationResult<Scorecard>
}

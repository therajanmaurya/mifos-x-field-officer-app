...
// module-deps.gradle.kts — the FORK-OWNED dependency seam for `core/store` (white-label).
//
// `core/store/build.gradle.kts` is template-owned and FULL-COPIES on `/kmp-project-template-sync`.
